...
[Link Library with iOS](https://facebook.github.io/react-native/docs/linking-libraries-ios.html) or 執行 `react-native link` 會自動幫你 iOS 與 Android 的 Library 都連結好
