...
隨著網路的普及, 瀏覽器在所有裝置已經無處不在, JavaScript 本身相當於已經是一種跨平台的程式語言, 而 React Native 則是基於 Facebook 本身開發的 React 框架, 要讓開發者除了沿用 React 的體驗, 可以設計出更直覺、優雅、跨平台的 UI 外, 加上能使用到原生的 UI 元件的好處。