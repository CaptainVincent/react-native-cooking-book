# 觸控元件
這邊介紹基礎感測觸控的元件 及 客製化的方式。

***
## TouchableHighlight
任何回應使用者觸控事件的介面元素都應該被 TouchableHighlight 標籤包裝著, 該元件會與以下事件建立掛鉤 (更多可以參閱[這裡](https://facebook.github.io/react-native/docs/touchablewithoutfeedback.html#props)), 開發者再將其行為定義即可。
